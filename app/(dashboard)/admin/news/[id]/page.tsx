...
export default async function NewsPostDetailPage({
  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      >
        <ArrowLeft size={14} /> Back to news stories
      </Link>
      ...
      {post.excerpt && (
        <div>
          <h2 className="font-mono text-[10px] uppercase tracking-widest text-slate-400">Summary</h2>
      ...
      {post.content?.text && (
        <div>
          <h2 className="font-mono text-[10px] uppercase tracking-widest text-slate-400">Story</h2>
